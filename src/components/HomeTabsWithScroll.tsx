      ...
      <div className="flex-1">
        ...
        <TabsContent value="about" className="px-6 flex flex-col items-center max-w-[900px] m-0">
          <div className="my-4 rounded w-full p-4 flex flex-col gap-3 text-md">
            ...
            <p className="text-tx-body">I consider myself, first-and-foremost, a designer. I graduated from the University of Washington&apos;s Interaction Design program in 2024, where I ultimately focused on sharpening my design process. This involved extensive user research&mdash;both academically, and professionally.</p>
            <p className="text-tx-body">But historically, I&apos;ve spent a lot of time developing. I have extensive experience in frontend technologies, my bread-and-butter being Next.js + TailwindCSS. Recently, I&apos;ve developed proficiency in Rust and Swift. I&apos;ve also worked with 3D technologies: namely, prototyping with extended reality (XR) in C# (Unity + Meta&apos;s XR SDK). My niche in XR focuses on hand/gestural interactions&mdash;i.e., designing for a future without traditional controllers.</p>
            ...
            <p className="text-tx-body">Mostly recently, I have been building <a href="https://www.instagram.com/zojer.studio/" target="_blank" rel="noopener noreferrer" className="text-blue-600 dark:text-blue-400 hover:underline">Kairos</a>, a professional astrology tool that intends to outclass all others, starting from a foundation of strong UX—not features. (The features will arise naturally, especially considering my <a href="https://www.davidschultz.co/blog/rapid-refactoring" rel="noopener noreferrer" className="text-blue-600 dark:text-blue-400 hover:underline">development process</a>.) I&apos;v been getting heavy use out of Claude Code, and have a lot of thoughts on how this technology will shape the world, especially given the current social climate. Blog post on those topics later!</p>
          </div>
        </TabsContent>
      </div>
    </Tabs>
